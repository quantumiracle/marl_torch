...
def get_args():
    ...
    parser.add_argument('--selfplay', action='store_true', default=False, help='The selfplay mode')
    parser.add_argument('--load-agent', type=str, default=None, help='Load agent models by specifying: 1, 2, or both')
    parser.add_argument('--train-both', action='store_true', default=False, help='Train both agents rather than train the second player only as default')
